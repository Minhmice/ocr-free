...
3. **Detect existing code (brownfield detection):**
   ...
   HAS_CODEBASE_MAP=$([ -d .cursor/codebase ] && echo "yes")
   ```
...
**If existing code detected and .cursor/codebase/ doesn't exist:**
...
1. Read `.cursor/codebase/ARCHITECTURE.md` and `STACK.md`
